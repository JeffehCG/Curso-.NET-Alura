<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePrincipal.Master" AutoEventWireup="true" CodeBehind="contatos.aspx.cs" Inherits="_3__WaAgenda.contatos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox ID="txbNome" runat="server" Width="360px"></asp:TextBox>
    <br />
    <asp:Label ID="Label3" runat="server" Text="E-mail: "></asp:Label>
    <asp:TextBox ID="txbEmail" runat="server" Width="360px"></asp:TextBox>
    <br />
    <asp:Label ID="Label4" runat="server" Text="Telefone: "></asp:Label>
    <asp:TextBox ID="txbTelefone" runat="server" Width="348px"></asp:TextBox>
    <br />
    <asp:Button ID="btInserir" runat="server" Text="Inserir" OnClick="btInserir_Click" Width="206px" />
